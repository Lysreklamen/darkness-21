	...
	private void waveover(int loops)
	{
		for (int k=0; k<loops*rainbow48.length; k++) {
			for (int j=0; j<columns.length; j++) {
				...
				int valG = (int)(rainbow48[(k+12)%rainbow48.length]*(2+Math.sin(phase+j*2.0*Math.PI/40))/3.0);
				int valB = (int)(rainbow48[(k+24)%rainbow48.length]*(2+Math.sin(phase+j*2.0*Math.PI/40))/3.0);
